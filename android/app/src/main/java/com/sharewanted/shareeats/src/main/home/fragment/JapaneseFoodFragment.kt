...
class JapaneseFoodFragment(val dongName: String) : Fragment() {
    ...
    private lateinit var binding : FragmentJapaneseFoodBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentJapaneseFoodBinding.inflate(inflater, container, false)
        return binding.root
    }
